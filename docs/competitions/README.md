...
| **2026 cohort has zero solo independent builders** | Enumerated all 33 grantees via `grantee-sitemap.xml`; sampled 10 pages. Every sampled grantee is institutional: Boston U associate prof (Varia), **Google DeepMind** (Gooen), **Allen Institute** (Shor), UCSD/MIT assistant prof (Khosla), Radboud (Nellessen), USC FORTIS Lab (Zhao), named nonprofits with public reach (**Ludlow Institute, 1M subscribers**; **Project Sovereign**; Sudo ML). Independent individuals are *not* absent from Foresight history — they exist in earlier AI Nodes cohorts — but **0/33 in the 2026 Nodes cohort**. Earlier draft's "≈5/130 independent" was never verified against this cohort and should be treated as superseded. | **−−** |
| **Programme says independents are welcome** | Third-party grant directory (aisecurityandsafety.org, not primary source): *"independent researchers without institutional support ... are particularly well-suited"*, *"Evidence of self-direction and productive independent work strengthens applications"*, floor of **$10K** per grant, ≈$3M/yr total. Directionally favourable, but it is the programme marketing itself, not evidence that independents were actually funded. | **+** (weak, source-graded) |
...
**The arithmetic.** Foresight awards ≈**$3M/year**; the 2026 cohort is **33 grantees** ⇒ ≈33 awards/year. That is a low-single-digit base rate *before* applying the remote-only penalty and the cohort-composition penalty above. Take **P = 2%**, grant **$40K** ⇒ **EV ≈ $800**.
