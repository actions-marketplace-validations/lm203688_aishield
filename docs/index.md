...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "AIShield 是什么？", "acceptedAnswer": { "@type": "Answer", "text": "AIShield 是一个开源、本地优先的 AI Agent 安全扫描器与信任机构，检测工具投毒、提示注入、密钥泄露、沙箱配置错误与供应链风险，覆盖 238 条 MCP 规则 / 244 条 Skill 规则，对齐 OWASP MCP Top 10 与 OWASP Agentic AI Top 10。" } },
...
- **238 条 MCP 规则 / 244 条 Skill 规则**，含由真实漏洞情报与技术雷达自动起草、经六项闸门校验后晋升的规则
